...
<div class="container mx-auto flex items-center justify-between px-4 py-0">
    <div class="game-details border-b border-gray-800 pb-12 flex">
        ...
        <div class="ml-12">
            ...
            <div class="flex flex-wrap mt-8 mr-64 items-center">

                <div class="flex items-center">

                    <div class="w-16 h-16  rounded-full bg-gray-700 flex items-center">
                        <div class="font-semibold text-xs flex text-center justify-center items-center h-full w-full">
                            80%
                        </div>

                    </div>
                    <div class="ml-4 text-xm">Member <br>Score</div>


                    <div class="w-16 h-16 ml-8 rounded-full bg-gray-700 flex items-center">
                        <div class="font-semibold text-xs flex text-center justify-center items-center h-full w-full">
                            92%
                        </div>

                    </div>
                    <div class="ml-4 text-xm">Critic <br>Score</div>



                    <div class="flex items-center space-x-4 ml-8">
                        <div class="bg-gray-700 rounded-full flex justify-center items-center w-8 h-8">
                ...
                <div class="description mt-12">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus culpa excepturi praesentium
                        dolorem natus, aut, magni ullam, voluptatum cum eos non quod repudiandae nemo a autem
                        voluptates. Perspiciatis, temporibus! Cum?</p>

                </div>

                <div>
                    <button
                        class="flex mt-12 rounded transition ease-in-out duration-150 bg-blue-600 text-white font-semibold px-4 py-4 hover:bg-blue-400">
...
<div class="images container mx-auto px-4 py-0  border-gray-800 pb-12 mb-8 mt-12">
    <h2 class="text-blue-500 uppercase tracking-wide font-semibold mb-8"> Images</h2>
